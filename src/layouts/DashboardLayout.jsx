...
export default function DashboardLayout() {
  ...
  const nav = useMemo(
    () => [
      { to: "/student/dashboard", label: t("student.nav.dashboard", "Dashboard") },
      { to: "/student/assessment", label: t("student.nav.assessment", "Assessment") },
      { to: "/student/results", label: t("student.nav.results", "Results") },
      { to: "/student/profile", label: t("student.nav.profile", "Profile") },
    ],
    []
  );
      ...
      <div className="sticky top-0 z-30 border-b border-[var(--border)] bg-white md:hidden">
        <div className="flex items-center justify-between px-4 py-3">
          ...
          <div className="text-sm font-semibold">
            {t("student.portal.title", "Student Portal")}
          </div>
        ...
        <aside className="hidden h-screen w-[260px] shrink-0 border-r border-[var(--border)] bg-white md:flex md:flex-col">
          <div className="px-5 py-4">
            ...
            <div className="mt-1 text-xs text-[var(--text-muted)]">
              {t("student.portal.subtitle", "Clean & safe experience")}
            </div>
            <div className="mt-3">
              <LanguageSwitcher compact />
            </div>
          ...
          <div className="border-t border-[var(--border)] px-5 py-4">
            <div className="text-xs text-[var(--text-muted)]">
              {t("student.portal.signedIn", "Signed in")}
            </div>
            <div className="text-sm font-medium">
              {t("student.portal.role", "Student")}
            </div>
          </div>
        </aside>
